...
def fetch_content(url):
    ...
    content_div = soup.find("div", id="showReading", class_="text-left")
...
base_url = "https://www.sonicmtl.com/novel/netherils-glory/chapter-"
...
# current_chapter = 885 # The current chapter number
